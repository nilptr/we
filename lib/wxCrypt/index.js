...
function WXBizMsgCrypt (token, encodingAESKey, appId) {
  ...
  if (encodingAESKey.length !== 43)
    throw new Error('Illegal encodingAESKey');
...
WXBizMsgCrypt.prototype.decrypt = function (ciphertext) {
  ...
  if (devAppId !== this.appId)
    throw new Error('Validate AppId Error');
...
WXBizMsgCrypt.prototype.decryptMsg = function (msgSignature, timeStamp, nonce, encryptMsg) {
